...
if __name__ == '__main__':
    ...
    file_name = '../datasets/mouse_cell_atlas_filteredcell2_2000.csv'
    label_name = '../datasets/mouse_cell_atlas_filteredcell2_labels.csv'
...
# =============================================================================
#     batch = pd.read_csv('../mouse_cell_atlas_labels.csv',index_col=0)['batch'].values
#     plt.figure(figsize=(8, 8))
